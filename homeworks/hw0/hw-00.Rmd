...
author: "Due: Friday February 5, 2021 at 5 PM EDT"
output: 
     pdf_document:
      includes: 
...
\item (5 points) Read the six page paper describing the Jaro-Winkler string metric, ``String Comparator Metrics and Enhanced Decision Rules in the Fellegi-Sunter Model of Record Linkage.
