...
\emph{Office Hour}: TBD \\
\textbf{692 113 2482 (Class and OH ID)}\\
...
\begin{enumerate}
\item Professor Steorts, Assistant Professor, TBD \\
\textbf{Meeting ID: 692 113 2482}
\item Olivier Binette, PhD Student, TBD\\
\textbf{Meeting ID: XXXX}
\end{enumerate}
...
\item Learn to work in a reproducible environment using GitHub 
...
\item Getting exposure to distributed computing via Apache Spark and understanding fundamentals of connections between statistical science and machine learning 
\item Four quizzes to test your knowledge of the area that are open note and open book (and timed). 
...
All lecture notes, assignment instructions, up-to-date schedule, and other course materials may be found on the course website: \textbf{update when ready}. The course webpage (including the course github page) will be updated regularly, so please make sure to check for updates often. \\
...
\item There will be between 3 -- 5 homework assignments during the course of the semester.  
...
%Exam  II: Thursday, October 29, 2020 & 20\%\\
