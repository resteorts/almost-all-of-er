...
The goal of your project must be motivated by a real application of entity resolution. Undergraduate students will work in pairs, and will be supervised by a master's student. Master's students can work solo if they choose will approval of Professor Steorts.  

Each group will have the following goals:

1. Choose an application of entity resolution that is approved by Professor Steorts and Olivier. What is the application and what are the goals of the applied problem that the group is going to tackle? 
