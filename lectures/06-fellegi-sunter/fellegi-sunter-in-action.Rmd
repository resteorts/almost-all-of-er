...
Stochastic record linkage relies on the assumption of
conditional probabilities concerning comparison pat-
terns.

The probabilities of the random vector $\gamma = (\gamma_1, \ldots \gamma_n)$
having value $\tilde{\gamma} = (\tilde{\gamma}_1, \ldots \tilde{\gamma}_n)$ conditional on the match status $Z$ are defined by
