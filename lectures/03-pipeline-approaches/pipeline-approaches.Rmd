...
Recall the \texttt{RLdata500} data set, removing any columns that contain missing values.
...
This takes a few minute to compute in \texttt{R}. (There are more efficient ways to do this). 
...
Let's plot the total number of record pair comparisons versus the number of featurs that disagree. 
