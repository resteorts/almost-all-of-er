...
---
title: "Module X: Probabilistic Blocking, Part I"
...
\vfill
A better approach for datasets of any realistic size is to use *hashing*, which we will look at next time. 
\vfill
