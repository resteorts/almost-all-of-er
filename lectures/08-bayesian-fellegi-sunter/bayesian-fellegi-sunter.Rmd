...
- We also, get an approximate posterior distribution, allowing use to know the posterior variance of the sample mean and full posterior distributions of evaluation metrics. Such uncertainty quanification is NOT possible from a probabilistic point of view. 
