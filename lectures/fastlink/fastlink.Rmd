...
matches <- 
  data.table(cbind(out$matches$inds.a,     out$matches$inds.b))
head(matches)
dim(matches)[1]
```
...
<!-- ```{r} -->
<!-- # Duplication/not duplication under unique id -->
<!-- recordsfL$dupTrue <- ifelse(duplicated(records$ent_id), "Duplicated", "Not duplicated") -->

<!-- # Duplication/not duplication under fastLink  -->
<!-- recordsfL$dupfL <- ifelse(duplicated(records$dedupe.ids), "Duplicated", "Not duplicated") -->

<!-- # Confusion Matrix  -->
<!-- confusion <- table("fastLink" = records$dupfL, "True" = recordsfL$dupTrue) -->
